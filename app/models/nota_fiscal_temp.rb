    ...
    NotaFiscalTemp.where(sent_to_master: false)
      ...
      if nota_fiscal.blank?
        params = {
                    ...
                    vendedor_id: (Vendedor.find_by_codigo_sistema_legado(nota_fiscal_temp.vendedor_id).id rescue nil),
                    cliente_id: (Cliente.find_by_codigo_sistema_legado(nota_fiscal_temp.cliente_id).id rescue nil),
                    produto_id: (Produto.find_by_codigo_sistema_legado(nota_fiscal_temp.produto_id).id rescue nil),
